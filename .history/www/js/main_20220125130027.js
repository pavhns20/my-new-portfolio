...
setInterval(function () {
	$(".touch-1")
		...
		.css({
			top: Math.floor(Math.random() * 600) + 1, //offsets
	...
	$(".touch-2")
		...
		.css({
			top: Math.floor(Math.random() * 400) + 1, //offsets
	...
	$(".touch-3")
		...
		.css({
			top: Math.floor(Math.random() * 700) + 1, //offsets
	...
	$(".touch-4")
		...
		.css({
			top: Math.floor(Math.random() * 300) + 1, //offsets
	...
	$(".touch-5")
		...
		.css({
			top: Math.floor(Math.random() * 500) + 1, //offsets
